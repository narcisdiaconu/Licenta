...
import { BusStopComponent } from 'app/entities/buses/bus-stop/bus-stop.component';
...
describe('Component Tests', () => {
    describe('BusStop Management Component', () => {
        let comp: BusStopComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BusStopComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.busStops[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
